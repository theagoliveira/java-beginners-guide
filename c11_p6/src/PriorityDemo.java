...
class PriorityDemo {
    public static void main(String[] args) {
        var mt1 = new Priority("High Priority");
        var mt2 = new Priority("Low Priority");
        var mt3 = new Priority("Normal Priority #1");
        var mt4 = new Priority("Normal Priority #2");
        var mt5 = new Priority("Normal Priority #3");
